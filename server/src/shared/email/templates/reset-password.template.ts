import { ResetPasswordTemplateOptions } from "../types/resetpassword-template";
...
<title>Reset your IMS password</title>
<!--[if mso]>
<noscript>
  <xml>
...
<style>
  ...
  /* Dark-mode support for clients that respect it (Apple Mail, iOS Mail, Outlook.com, some Android) */
...
<body class="bg-body" style="margin:0; padding:0; background-color:#f4f7f9; font-family: 'Inter', 'Segoe UI', Helvetica, Arial, sans-serif;">
  ...
  <div style="display:none; max-height:0; overflow:hidden; mso-hide:all; font-size:1px; line-height:1px; color:#f4f7f9;">
    Reset your IMS password — this link expires in 60 minutes.
  </div>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="vertical-align:middle;">
                    <!-- Logo mark: hex badge, built with table cells since SVG support is unreliable in email -->
                    <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                ...
                <tr>
                  <td>
                    ...
                    <p class="text-secondary" style="margin:0 0 28px; font-family:'Inter','Segoe UI',Arial,sans-serif; font-size:15px; line-height:1.6; color:#384f60;">
                      We received a request to reset the password for your IMS account. Click the button below to choose a new one. This link expires in <strong>60 minutes</strong>.
                    </p>
                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td align="center" style="border-radius:8px; background-color:#1c3f5f;">
                          <!--[if mso]>
                          <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${resetLink}" style="height:48px;v-text-anchor:middle;width:220px;" arcsize="14%" fillcolor="#1c3f5f" strokecolor="#1c3f5f">
                          <w:anchorlock/>
                          <center style="color:#f4f7f9;font-family:Arial,sans-serif;font-size:15px;font-weight:bold;">Reset password</center>
                          </v:roundrect>
                          <![endif]-->
                          <!--[if !mso]><!-->
                          <a href="${resetLink}" class="btn" target="_blank" style="display:inline-block; padding:14px 32px; font-family:'Inter','Segoe UI',Arial,sans-serif; font-size:15px; font-weight:600; color:#f4f7f9; background-color:#1c3f5f; border-radius:8px; text-decoration:none;">
                            Reset password
                          </a>
                          <!--<![endif]-->
                        </td>
                    ...
                    <p class="text-muted" style="margin:28px 0 8px; font-family:'Inter','Segoe UI',Arial,sans-serif; font-size:13px; line-height:1.6; color:#7999ab;">
                      Button not working? Copy and paste this link into your browser:
                    </p>
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" class="bg-code border-soft" style="background-color:#f4f7f9; border:1px solid #e6edf1; border-radius:6px;">
                      <tr>
                        <td style="padding:12px 14px;">
                          <a href="${resetLink}" class="link-fallback" style="font-family:'JetBrains Mono','Courier New',monospace; font-size:12px; color:#446277; word-break:break-all;">${resetLink}</a>
                        </td>
                      </tr>
                    </table>
